  ...
  if (task.hostApp === "cursor") {
    ...
    try {
      const { stdout } = await execFileAsync("osascript", [
        ...
        "-e",
        'set positionValue to {-1, -1}',
        "-e",
        'set sizeValue to {-1, -1}',
        "-e",
        'set windowNumberValue to -1',
        "-e",
        'set identifierValue to ""',
        "-e",
        'try',
        "-e",
        'set nameValue to (name of targetWindow as text)',
        "-e",
        "end try",
        "-e",
        'try',
        ...
        'try',
        "-e",
        'set windowNumberValue to value of attribute "AXWindowNumber" of targetWindow',
        "-e",
        "end try",
        "-e",
        'try',
        ...
        'set matchScore to 0',
        "-e",
        'if targetWindowNumber is not -1 and windowNumberValue is targetWindowNumber then set matchScore to matchScore + 2000',
        "-e",
        'if targetWorkspace is not "" and nameValue is targetWorkspace then set matchScore to matchScore + 3200',
        "-e",
        'if targetTitle is not "" and nameValue is targetTitle then set matchScore to matchScore + 1500',
        "-e",
        'if targetIdentifier is not "" and identifierValue is targetIdentifier then set matchScore to matchScore + 1200',
        "-e",
        'if targetDocument is not "" and documentValue is targetDocument then set matchScore to matchScore + 900',
        "-e",
        'if targetWorkspace is not "" and documentValue contains ("/" & targetWorkspace & "/") then set matchScore to matchScore + 260',
        "-e",
        'if targetTitle is not "" and titleValue is targetTitle then set matchScore to matchScore + 80',
        "-e",
        'if targetWorkspace is not "" and titleValue ends with ("— " & targetWorkspace) then',
        "-e",
        'set matchScore to matchScore + 120',
        "-e",
        'else if targetWorkspace is not "" and titleValue contains targetWorkspace then',
        "-e",
        'set matchScore to matchScore + 40',
        "-e",
        'end if',
        "-e",
        'if targetPosition is not {-1, -1} and positionValue is targetPosition then set matchScore to matchScore + 40',
        "-e",
        'if targetSize is not {-1, -1} and sizeValue is targetSize then set matchScore to matchScore + 40',
        "-e",
        'return matchScore >= 200',
        "-e",
        "end tell",
        "-e",
        "end tell"
